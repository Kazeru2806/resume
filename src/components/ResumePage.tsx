...
export default function ResumePage() {
    ...
    const portfolioImages = [
        ...
        { title: "IELTS Lastest Result", img: '/ielts.png' },
                    ...
                    <div style={{ animation: 'fadeInUp 1s ease-out 1.6s backwards', gridRow: '1 / 3' }}>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', fontSize: '0.8rem' }}>
                            <div>
                                ...
                                <p style={{ fontWeight: '700', color: '#1f2937', marginBottom: '0.25rem' }}> PART-TIME CODING AND ROBOTICS LECTURER</p>
                            ...
                            <div>
                                ...
                                <a href="https://github.com/Kazeru2806/vn-party-thesis" target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'none' }}>
                                    <p style={{ fontWeight: '700', color: '#1d4ed8', marginBottom: '0.25rem', cursor: 'pointer', transition: 'all 0.3s ease' }} onMouseEnter={(e) => e.currentTarget.style.opacity = '0.7'} onMouseLeave={(e) => e.currentTarget.style.opacity = '1'}>THESIS PROJECT – VN PARTY: REAL-TIME MULTIPLAYER PARTY GAME PLATFORM</p>
                                </a>
                                <p style={{ color: '#374151', marginBottom: '0.25rem' }}>University Project</p>
                                <ul style={{ color: '#4b5563', paddingLeft: 0, marginTop: '0.25rem', lineHeight: '1.6' }}>
                                    <li style={{ paddingLeft: '1.2rem', marginBottom: '0.4rem' }}><span style={{ display: 'inline-block', width: '0.6rem', marginLeft: '-1.2rem', marginRight: '0.5rem', color: '#000000ff' }}>✦</span>Built a full-stack real-time multiplayer quiz platform (Elixir/Phoenix + React/TypeScript) supporting 500 concurrent game rooms with p95 latency of 16ms.</li>
                                    <li style={{ paddingLeft: '1.2rem', marginBottom: '0.4rem' }}><span style={{ display: 'inline-block', width: '0.6rem', marginLeft: '-1.2rem', marginRight: '0.5rem', color: '#000000ff' }}>✦</span>Implemented a SHA-256 commit-reveal anti-cheat system achieving 100% detection across 400 automated adversarial attempts (hash tampering, replay, late commits, timing manipulation).</li>
                                    <li style={{ paddingLeft: '1.2rem', marginBottom: '0.4rem' }}><span style={{ display: 'inline-block', width: '0.6rem', marginLeft: '-1.2rem', marginRight: '0.5rem', color: '#000000ff' }}>✦</span>Designed an optional blockchain audit trail with EVM anchoring, adding only ~2.1ms overhead per event for tamper-evident post-game verification.</li>
                                    <li style={{ paddingLeft: '1.2rem', marginBottom: '0.4rem' }}><span style={{ display: 'inline-block', width: '0.6rem', marginLeft: '-1.2rem', marginRight: '0.5rem', color: '#000000ff' }}>✦</span>Built end-to-end evaluation pipeline using k6 load testing and Linux tc/netem network emulation across 6,900+ measured sessions.</li>
                                </ul>
                            </div>
                            <div>
                            ...
                            <div>
                                <p style={{ color: '#6b7280', marginBottom: '0.25rem' }}>2025 – 2026</p>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', fontSize: '0.8rem' }}>
                            ...
                            <div style={{ marginTop: '0.5rem' }}>
                                ...
                                <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap' }}>
                                    <a href="https://drive.google.com/file/d/1_9f_EM8EFWKE9Df4gyJChxIvKq-U5hbz/view?usp=drive_link" target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'none' }}>
                                        <div style={{ backgroundColor: '#e5e7eb', color: '#1f2937', padding: '0.25rem 0.5rem', borderRadius: '9999px', fontSize: '0.75rem' }}>English (IELTS: 7.5)</div>
                                    </a>
