...
export default function ResumePage() {
    ...
    useEffect(() => {
        const handleEsc = (e: KeyboardEvent) => {
            if (e.key === 'Escape') setCaseStudyOpen(false);
        };
        ...
        <div className="resume-page">
            ...
            <section className="hero">
                ...
                <div className="hero-ctas">
                    <a href="/resume.pdf" target="_blank" rel="noopener noreferrer" className="cta-btn primary">
                        📄 Download Resume (PDF)
                    </a>
            ...
            <section id="projects" className="resume-section reveal-section">
                ...
                <div className="projects-grid">
                    ...
                    <div className="project-card">
                        <img src="/fruit.png" alt="VN Party" className="project-card-img" />
                    ...
                    {/* Panorama Stitcher */}
                    <div className="project-card">
                        <img src="/panorama.png" alt="Panorama Stitcher" className="project-card-img" />
                        <div className="project-card-body">
                    ...
                    {/* Dining Guide */}
                    <div className="project-card">
                        <img src="/dining.png" alt="Dining Guide Web" className="project-card-img" />
                        <div className="project-card-body">
